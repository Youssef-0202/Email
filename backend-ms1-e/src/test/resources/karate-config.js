function fn() {
    ...
    const urlDev = 'jdbc:mysql://localhost:3306/emailling';
    ...
    config.emailUrl = config.adminUri + 'email/';
    config.emailDetailUrl = config.adminUri + 'emailDetail/';
    config.keepNoteUrl = config.adminUri + 'keepNote/';
    config.emailGroupePieceJointUrl = config.adminUri + 'emailGroupePieceJoint/';
    config.utilisateurUrl = config.adminUri + 'utilisateur/';
    config.groupeEmailUrl = config.adminUri + 'groupeEmail/';
    config.emailDetailGroupUrl = config.adminUri + 'emailDetailGroup/';
    config.typeContenuUrl = config.adminUri + 'typeContenu/';
    config.categoryEmailUrl = config.adminUri + 'categoryEmail/';
    config.contactUrl = config.adminUri + 'contact/';
    config.etatEmailUrl = config.adminUri + 'etatEmail/';
    config.emailpieceJoinUrl = config.adminUri + 'emailpieceJoin/';
    config.groupeEmailDetailUrl = config.adminUri + 'groupeEmailDetail/';
