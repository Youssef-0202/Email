...
@Component({
  selector: 'app-emailpiece-join-create-admin',
  templateUrl: './emailpiece-join-create-admin.component.html'
})
export class EmailpieceJoinCreateAdminComponent extends AbstractCreateController<EmailpieceJoinDto, EmailpieceJoinCriteria, EmailpieceJoinAdminService>  implements OnInit {
