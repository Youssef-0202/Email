                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: EmailListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: EmailDetailListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            path: 'emailpiece-join',
                            children: [
                                {
                                    path: 'list',
                                    component: EmailpieceJoinListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class EmailAdminRoutingModule { }
